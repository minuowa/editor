...
struct qt_meta_stringdata_EObjectListSheet_t {
    QByteArrayData data[6];
    char stringdata[72];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EObjectListSheet_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EObjectListSheet_t qt_meta_stringdata_EObjectListSheet = {
    {
...
QT_MOC_LITERAL(5, 61, 10)
    ...
    "EObjectListSheet\0onSelectionChanged\0"
    "\0QItemSelection\0selected\0deselected"
};
...
const QMetaObject EObjectListSheet::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_EObjectListSheet.data,
      qt_meta_data_EObjectListSheet,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EObjectListSheet.stringdata))
        return static_cast<void*>(const_cast< EObjectListSheet*>(this));
    if (!strcmp(_clname, "CXCallBack"))
        return static_cast< CXCallBack*>(const_cast< EObjectListSheet*>(this));
