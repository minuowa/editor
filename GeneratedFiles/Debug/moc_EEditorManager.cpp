/****************************************************************************
** Meta object code from reading C++ file 'EEditorManager.h'
**
...
#error "The header file 'EEditorManager.h' doesn't include <QObject>."
...
struct qt_meta_stringdata_EEditorManager_t {
    QByteArrayData data[5];
    char stringdata[61];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_EEditorManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_EEditorManager_t qt_meta_stringdata_EEditorManager = {
    {
...
QT_MOC_LITERAL(4, 43, 17)
    ...
    "EEditorManager\0onAddObjectAction\0\0"
    "QAction*\0onComponentAction"
};
...
const QMetaObject EEditorManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_EEditorManager.data,
      qt_meta_data_EEditorManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EEditorManager.stringdata))
        return static_cast<void*>(const_cast< EEditorManager*>(this));
    if (!strcmp(_clname, "CXCallBack"))
        return static_cast< CXCallBack*>(const_cast< EEditorManager*>(this));
